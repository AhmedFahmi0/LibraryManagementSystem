...
public class BooksController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<BookProjection> getBookById(
	...
	@ApiOperation("get book by id")
	@PutMapping("/{id}")
	public ResponseEntity<BookProjection> updateBookById(
	...
	@GetMapping
	public ResponseEntity<List<BookProjection>> getAllBooks(
